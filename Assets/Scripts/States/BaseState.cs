...
namespace States
{
    public class BaseState
    {
        ...
        {
            gui = GameObject.Instantiate(CommonDataJT.prefabs.menuLookup[prefabLookup]);
            gui.transform.position = new Vector3(0, 0, UIDepthMobile);
            gui.transform.SetParent(CommonDataJT.canvasHolder.transform, false);
           // ResizeUI(gui);
        ...
        {
            Camera camera = CommonDataJT.canvasHolder.GetComponentInChildren<Camera>();
